...
class TermynalScenario {
   ...
   */
  constructor(container = "#termynalScenarioSc", options = {}) {
    this.container =
  ...
  loadLines() {
    ...
    this.container.setAttribute("data-termynalScenarioSc", "");
  }
  ...
  generateRestart() {
    ...
    restart.href = "#";
    restart.setAttribute("data-terminal-controlScenarioSc", "");
  ...
  generateFinish() {
    ...
    finish.href = "#";
    finish.setAttribute("data-terminal-controlSc", "");
 ...
 */
if (document.currentScript.hasAttribute("data-termynal-containerScenarioSc")) {
  const containers = document.currentScript.getAttribute(
    "data-termynal-containerScenarioSc"
  );
  containers.split("|").forEach((container) => new TermynalScenario(container));
}
