...
| ✅ | `text-blurring` | Blue any text detected (paper, computer screens etc) | [More details](blur-signs.md){:target="_blank"} |
| ✅ | `license-plate-blurring` | Blur any license plates detected | [More details](../privacy/blur-license-plates.md){:target="_blank"} |
| 📅 | `screens-blurring` | Blur any signs detected | [More details](../privacy/blur-screens.md){:target="_blank"} |
| 📅 | `obstructed-camera` | If camera feed is obstructed, send an alert | [More details](obstructed-camera-view.md){:target="_blank"} |
...
| 📅 | `environment-monitoring` | `CO out of range` <br> `CO2 out of range` <br> `CH4 out of range` <br> `VOCs out of range` <br> `Temperature out of range` <br> `Pressure out of range` <br> `Humidity out of range` |[More details](environment-monitoring.md){:target="_blank"}
...
| Status | Scenario name | Supported Events | Additional considerations |
| :----: | :------------ | :--------------- | :------------------------ |
| 📅 | `equipment-temperature`        | `Equipment temperature exceeds limit` <br> `Equipment temperature subsceeds limit` | [More details](equipment-temperature.md){:target="_blank"} |
...
| 📅 | `noise-level-monitoring` | `Noise level exceeds limit` <br> `Noise level subsceeds limit` | [More details](environment-noise.md){:target="_blank"} |
...
| 📅 | `VOC-monitoring` | `voc exceeds limit` | [More details](environment-voc.md){:target="_blank"} |
| 📅 | `Carbon monoxide-monitoring` | `Carbon monoxide excceds limit`| [More details](environment-co.md){:target="_blank"} |
...
| 📅 | `water-quality-monitoring` | `TODO` | [More details](environment-water-quality.md){:target="_blank"} |
...
| 📅 | `water-usage-monitoring` | `TODO` | [More details](environment-water-usage.md){:target="_blank"} |
| 📅 | `water-level-monitoring` | `TODO` | [More details](environment-water-level.md){:target="_blank"} |
...
| 📅 | `sexual harrasement` | `harrasement detected`| [More details](sexual-harassment.md){:target="_blank"} |
...
| 📅 | `vehicle-cargo-volume-limit` | `Vehicle cargo volume exceeds limit` | [More details](vehicle-cargoz.md){:target="_blank"} |
