...
> What's included as part of this? Temperature monitoring, Air quality, humidity, pressure, & other areas which can be monitored through AI.

TODO: Provide an overview

## IoT Sensors based monitoring

!!! Note TODO: Environment Monitoring Overview
    What parameters are monitored
    How we can set up thresholds for these parameters
    What happens when these sensors go out of battery.
