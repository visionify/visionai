...
**VisionAI** is organized in terms of scenarios. Consider each scenario as being a business use-case, that is solved by a combination of Machine Learning models and an inference algorithm. For example _Warn me when max occupancy of this area exceeds 80 people_ is a business scenario, where as the _People detection_ is an ML model.
