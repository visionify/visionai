...
cs = 'DefaultEndpointsProtocol=https;AccountName=visionaimodels;AccountKey=s4s3YxVWexCAHAA3lUjp0+vllrHOM3hB5+9+rYjCWxfPtXW5OIrMUWTnRxk+mID6A7pwh1hksXnfYIpAlb6IRw==;EndpointSuffix=core.windows.net'
base_url = 'https://visionaimodels.blob.core.windows.net'
